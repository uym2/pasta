...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.treeshrink = UserSettingGroup('treeshrink')
        self._categories.append('treeshrink')
        ...
        self.treeshrink.add_option('path', StringUserSetting(name='path', default='', short_name=None, help='Path to TreeShrink executables', subcategory=None))
        self.treeshrink.add_option('args', StringUserSetting(name='args', default='', short_name=None, help='Arguments to be passed to TreeShrink.', subcategory=None))
        ...
        self.commandline.add_option('alignmentsuffix', StringUserSetting(name='alignment-suffix', default=None, short_name=None, help='suffix for alignment name (default: .marker001.[input name].aln)', subcategory=None))
        ...
        self.sate.add_option('break_constraint', ChoiceUserSetting(name='break_constraint', default='nleaves', choices=['nleaves', 'brlen'], multiple_choices=False, short_name=None, help='The constraint on the maximum size of each subtree after decomposition (e.g. if the constraint is "nleaves", each subtree cannot have more than k leaves where k is set by "max_subproblem_size". [default: nleaves]', subcategory='decomposition'))
        self.sate.add_option('max_subproblem_size', IntUserSetting(name='max_subproblem_size', default=200, min=0, max=None, short_name=None, help='Can only be used with "break_constraint=nleaves". The maximum size (number of leaves) of subproblems.  When a subproblem contains this number of leaves (or fewer), then it will not be decomposed further. [default: automatically picked based on alignment size]', subcategory='decomposition'))
        self.sate.add_option('min_subproblem_size', IntUserSetting(name='min_subproblem_size', default=0, min=0, max=None, short_name=None, help='Can only be used with "break_co    nstraint=nleaves" and NOT with mincluster break-strategy. The minimum size (number of leaves) of subproblems. [default: 0]', subcategory='decomposition'))
        self.sate.add_option('max_subtree_brlen', FloatUserSetting(name='max_subtree_brlen', default=0, min=0, max=None, short_name=None, help='Can only be used with "break_constraint=brlen". The maximum total branch length of each subtree. [default: automatically determined based on the input]', subcategory='decomposition'))
        self.sate.add_option('max_subtree_brlen_frac', FloatUserSetting(name='max_subtree_brlen_frac', default=0, min=0, max=1, short_name=None, help='Can only be used with "break_constraint=brlen". The maximum total branch length of each subtree (subproblem) in proportion to the total branch length of the (starting/estimated) tree. [default: automatically determined based on the input]', subcategory='decomposition'))
        self.sate.add_option('expected_subproblem_size', IntUserSetting(name='expected_subproblem_size', default=200, min=0, max=None, short_name=None, help='Can only be used with "break_constraint=brlen". The expected (number of leaves) of subproblems. After decomposition based on branch length, each subproblem will contain roughly this many sequences[default: automatically picked based on alignment size]', subcategory='decomposition'))
        ...
        self.sate.add_option('treeshrink_filter', BoolUserSetting(name='treeshrink_filter', default='False', short_name=None, help='If used, then the inferred FastTree will be filtered by TreeShrink for long branch outliers.', subcategory='filtering'))
