...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.sate.add_option('break_constraint', ChoiceUserSetting(name='break_constraint', default='nleaves', choices=['nleaves', 'brlen'], multiple_choices=False, short_name=None, help='The constraint on to control the maximum size of each subtree after decomposition (e.g. if the constraint is "nleaves", each subtree cannot have more than k leaves where k is set by "max_subproblem_size". [default: nleaves]', subcategory='decomposition'))
        ...
        self.sate.add_option('min_subproblem_size', IntUserSetting(name='min_subproblem_size', default=0, min=0, max=None, short_name=None, help='Can only be used with "break_co    nstraint=nleaves". The minimum size (number of leaves) of subproblems. [default: 0]', subcategory='decomposition'))
        self.sate.add_option('max_subtree_brlen_frac', FloatUserSetting(name='max_subtree_brlen_frac', default=0, min=0, max=1, short_name=None, help='Can only be used with "break_constraint=brlen". The maximum total branch length of each subtree (subproblem) in proportion to the total branch length of the tree.  When the (sum branch length of a subtree / sum branch length of the tree) is less than or equal to this number, it will not be decomposed further. [default: max_subproblem_size/n where n is the number of leaves]', subcategory='decomposition'))
