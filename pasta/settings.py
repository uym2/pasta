...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.sate.add_option('max_subtree_brlen', FloatUserSetting(name='max_subtree_brlen', default=0, min=0, max=None, short_name=None, help='Can only be used with "break_constraint=brlen". The maximum total branch length of each subtree (subproblem).  When the total branch length of a subtree is less than or equal to this number, it will not be decomposed further. [default: max_subproblem_size*B/n where B is the sum of all branches in the tree and n is the number of leaves]', subcategory='decomposition'))
